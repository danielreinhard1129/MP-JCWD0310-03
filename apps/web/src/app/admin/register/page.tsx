  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="h-[600px] max-w-full">
        ...
        >
          <h1 className="md:py- text-xl font-bold text-[#393e41]">
          ...
          <div className="space-y-2">
            ...
            <label className="input input-bordered flex h-[40px] items-center gap-2 rounded-lg text-[#393e41]">
          ...
          <p className="text-[#393e41]">
            ...
            <Link href="/admin/login" className="text-[#e94f37]">
              Login
            </Link>{" "}
          </p>
        </form>
